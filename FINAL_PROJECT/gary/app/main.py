...
patton_ai = aitextgen(model_folder = "patton_owswald", to_gpu=False)
dad_ai = aitextgen(model_folder = "model", to_gpu=False)
...
#def censor():
    #generated[0].replace("fuck", "****")
    #generated[0].replace("shit", "****")
    #generated[0].replace("faggot", "******")
    #generated[0].replace("damn", "****")
    #generated[0].replace("bitch", "*****")
    #generated[0].replace("ass", "***")
    #generated[0].replace("cock", "****")
    #generated[0].replace("cunt", "****")
    #generated[0].replace("nigg", "****")
    #generated[0].replace("slut", "****")
    #generated[0].replace("tit", "***")
    #generated[0].replace("slut", "****")
    #generated[0].replace("whore", "*****")
    #generated[0].replace("dick", "****")
    #generated[0].replace("cum", "***")
    #generated[0].replace("pussy", "*****")
    #generated[0].replace("")
...
def generate_text():
    ...
    value = request.form['selected_model']
    if prompt is not None:
        if value == "1":
            generated = dad_ai.generate(
            n=1,
            batch_size=3,
            prompt=str(prompt),
            max_length=300,
